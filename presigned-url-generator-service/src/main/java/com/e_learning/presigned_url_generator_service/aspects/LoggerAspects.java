package com.e_learning.presigned_url_generator_service.aspects;
...
public class LoggerAspects {
    ...
    @Around("execution(* com.e_learning.presigned_url_generator_service..*.*(..))")
    ...
    @AfterThrowing(value = "execution(* com.e_learning.presigned_url_generator_service.*.*(..))", throwing = "ex")
