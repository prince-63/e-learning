package com.e_learning.auth_service.aspects;
...
public class LoggerAspects {
    ...
    @Around("execution(* com.e_learning.auth_service..*.*(..))")
    ...
    @AfterThrowing(value = "execution(* com.e_learning.auth_service.*.*(..))", throwing = "ex")
